...
class AppLocalizationsEn extends AppLocalizations {
  ...
  String get scanQrWebNotice =>
      'Ask the creator of the counter to send you the link, or download the mobile version of Shared Counter from the App Store or Play Store to scan the QR code';
  ...
  String get historyLoadingError =>
      'An error occurred while loading past counters';
  ...
  String get historyDeleteConfirmMessage =>
      'Do you really want to delete this counter from past counters? This operation cannot be undone.';
  ...
  String get incompleteSignUpErrorMessage =>
      'It appears that you have not completed the sign up procedure.\n\nTo sign in you must provide more details. Tap \"continue\" to be redirected to the web services and complete the registration.';

  @override
  String get webAppDownloadBanner =>
      'You are using the web app version of Shared Counter. If you have an Android or iOS device, download the native app!';
  ...
  String get shareQrCodeCaption =>
      'Scan the QR code on all the devices you want to count on';
  ...
  String get signInReservedWarning =>
      'Warning! Sign in is reserved for churches.';

  @override
  String get signInFormCaption =>
      'To collect count statistics for your church sign in with your DinDonDan account:';

  @override
  String get signInUnknownErrorMessage =>
      'An unknown error has occurred. Please try again later and if the problem persists write to feedback@dindondan.app.';
  ...
  String get signInUserNotFoundError =>
      'This address does not match any account.';

  @override
  String get signInUserDisabledError =>
      'This account has been disabled. For more information write to feedback@dindondan.app.';

  @override
  String get signInTooManyAttemptsError =>
      'You have made too many attempts. Try again later.';
  ...
  String get resetConfirmMessage =>
      'Do you really want to reset the counter? All data about this counter, including statistics, will be permanently deleted for all users. The users you shared this counter with will still have access.';
