...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get scanQrWebNotice => 'Demandez au créateur du compteur de vous envoyer le lien, ou téléchargez la version mobile de Compteur Partagé depuis l\'App Store ou le Play Store pour scanner le code QR';
  ...
  @override
  String get historyLoadingError => 'Une erreur s\'est produite lors du chargement des compteurs passés';

  @override
  String get historyDeleteConfirmTitle => 'Supprimer le compteur';

  @override
  String get historyDeleteConfirmMessage => 'Voulez-vous vraiment supprimer ce compteur des compteurs passés ? Cette opération est irréversible.';
  ...
  @override
  String get shareQrCodeCaption => 'Scannez le code QR sur tous les appareils que vous souhaitez utiliser pour compter';
  ...
  @override
  String get shareLinkCreationErrorTitle => 'Impossible de générer le lien de partage';

  @override
  String get shareLinkCreationErrorMessage => 'Veuillez vérifier votre connexion Internet et réessayer.';
  ...
  @override
  String get signUpButton => 'Vous n\'avez pas encore de compte ? Inscrivez-vous maintenant !';

  @override
  String get forgotPasswordButton => 'J\'ai oublié mon mot de passe';

  @override
  String get signInReservedWarning => 'Attention ! La connexion est réservée aux églises.';

  @override
  String get signInFormCaption => 'Pour collecter des statistiques de comptage pour votre église, connectez-vous avec votre compte DinDonDan :';

  @override
  String get signInUnknownErrorMessage => 'Une erreur inconnue s\'est produite. Veuillez réessayer plus tard et si le problème persiste, écrivez à feedback@dindondan.app.';

  @override
  String get signInInvalidEmailError => 'Adresse e-mail invalide. Veuillez vérifier et réessayer.';

  @override
  String get signInWrongPasswordError => 'Mot de passe incorrect.';

  @override
  String get signInUserNotFoundError => 'Cette adresse ne correspond à aucun compte.';

  @override
  String get signInUserDisabledError => 'Ce compte a été désactivé. Pour plus d\'informations, écrivez à feedback@dindondan.app.';

  @override
  String get signInTooManyAttemptsError => 'Vous avez fait trop de tentatives. Réessayez plus tard.';

  @override
  String get signInNetworkError => 'Impossible de se connecter au serveur. Veuillez vérifier votre connexion Internet et réessayer.';
  ...
  @override
  String get resetConfirmMessage => 'Voulez-vous vraiment réinitialiser le compteur ? Toutes les données concernant ce compteur, y compris les statistiques, seront définitivement supprimées pour tous les utilisateurs. Les utilisateurs avec qui vous avez partagé ce compteur auront toujours accès.';
